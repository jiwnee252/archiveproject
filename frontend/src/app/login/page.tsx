  ...
  return (
    <>
      <main className="flex justify-center items-center min-h-screen bg-background text-foreground">
        <div className="w-full max-w-sm p-6 rounded-lg shadow-lg bg-white dark:bg-neutral-900 ">
          ...
          <form className="flex flex-col gap-4">
            <input
              ...
              className="p-2 border rounded bg-transparent border-neutral-300 dark:border-neutral-600"
