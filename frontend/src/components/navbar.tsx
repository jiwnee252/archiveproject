...
export default function Navbar() {
  ...
  const toggleSubDropdown = (year: string) => {
              ...
              {item.href ? (
                ...
                <>
                  ...
                  {openDropdown === item.title && (
                    <div className="absolute top-full left-0 mt-2 bg-white dark:bg-[#2c2c34] border dark:border-gray-600 rounded-lg shadow p-4 min-w-[200px]">
                              ...
                              <div className="flex flex-col">
                                {year.months.map((month) => (
                                  <Link
                                    key={month.title}
                                    href={month.href}
                                    className="p-2 text-sm hover:bg-gray-100 dark:hover:bg-[#404040] rounded"
                                  >
                                    {month.title}
                                  </Link>
                                ))}
