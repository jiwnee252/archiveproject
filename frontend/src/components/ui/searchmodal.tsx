...
export default function SearchModal({ trigger }: { trigger: React.ReactNode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        {/* 텍스트 검색 */}
        <p className="text-center text-sm text-neutral-700 dark:text-neutral-300">내용으로 검색</p>
        <div
        ...
        {/* 날짜 검색 */}
        <p className="text-center text-sm text-neutral-700 dark:text-neutral-300">날짜로 검색</p>
        <div
          className="w-64 h-10 bg-white dark:bg-neutral-800 
          border border-neutral-300 dark:border-neutral-600 
          rounded-full px-4 py-2 relative"
